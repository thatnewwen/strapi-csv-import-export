...
const index = require("./index-CWDmb8kp.js");
...
const Preferences = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(index.Box, { style: { alignSelf: "stretch" }, background: "neutral0", padding: 8, hasRadius: true, children: /* @__PURE__ */ jsxRuntime.jsxs(index.Flex, { direction: "column", alignItems: "start", gap: 6, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(index.Box, { children: /* @__PURE__ */ jsxRuntime.jsx(index.Flex, { direction: "column", alignItems: "start", gap: 4, children: /* @__PURE__ */ jsxRuntime.jsx(index.Flex, { justifyContent: "space-between", children: /* @__PURE__ */ jsxRuntime.jsx(
      index.CheckboxImpl,
      {
...
exports.App = App;
//# sourceMappingURL=App-B63BYLIK.js.map
